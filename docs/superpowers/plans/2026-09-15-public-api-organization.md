...
- [x] Run `gofmt`, `go test ./... -count=1`, `go vet ./...`, the CLI fixture check, and Markdown link checks.
...
- The CLI fixture returned 3 pages, 104 text elements, 2,639 graphics, 1 image, 1 image resource, 1 font, 0 annotations, and the existing 8 interpretation diagnostics.
...
- The local test PDF and saved detailed JSON retain their original SHA-256 hashes and remain ignored by Git.
