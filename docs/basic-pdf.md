...
실제 타입 정의는 [basic_model.go](../basic_model.go)에 있습니다.
...
요소가 있으면 해당 페이지의 안쪽 배열에 Text 또는 Graphic 객체가 들어갑니다. 로컬 `테스트PDF.basic.json`은 다음 개수로 구성됩니다.

| 페이지 인덱스 | `Texts[page]` | `Graphics[page]` |
| --- | ---: | ---: |
| 0 | 58 | 1,052 |
| 1 | 39 | 1,571 |
| 2 | 7 | 16 |
